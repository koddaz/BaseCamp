...
fun AdminExtrasView(
    ...
    var itemName by remember { mutableStateOf(bookingName) }
    var itemInfo by remember { mutableStateOf(bookingInfo) }
    var itemPrice by remember { mutableStateOf(bookingPrice) }
